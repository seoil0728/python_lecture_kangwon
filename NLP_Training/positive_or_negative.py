...
class SentimentRNN(nn.Module):
    ...
    def __init__(self, vocab_size, output_size, embedding_dim, hidden_dim,
        ...
        self.lstm = nn.RNN(embedding_dim, hidden_dim, n_layers, batch_first=True)
...
def train(model, train_loader, valid_loader, criterion, optimizer,
          epochs = 4, print_every = 100, clip=5):
    counter = 0
...
train(net2, train_loader, valid_loader, criterion, optimizer2)
...
torch.save(net2.state_dict(), './data/trained.pt')
