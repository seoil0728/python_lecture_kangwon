...
def exampleCode(canvas, width, height,i):
    a = i * 20
    canvas.create_line(a,a,width/2+a,height/2+a,width=8,tags="oa")

    canvas.after(1000,exampleCode, canvas, width, height, i+1)
    canvas.after(800,canvas.delete,"oa")
...
def runCanvas(canvas_width, canvas_height):
    ...
    i=1
    exampleCode(canvas,canvas_width, canvas_height,i)
